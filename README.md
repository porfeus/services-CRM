...
Во всех вариантах генерации, после основных данных (Login, Pass, Tariff, должен идти текст, который может редактироваться и добавляться новый, на усмотрение админа. По умолчанию создаётся следующий текст:
